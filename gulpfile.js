...
function CopyFinal() {
    return merge(
        gulp.src(['dist/List.htm'])
         .pipe(gulp.dest('SD_WLAN')),
    )
}
...
var defaultSeries = gulp.series(clean,  lint, Copy, concatApp, minifyApp, includehtml, includehtml, smoosh, compress);
//var packageSeries = gulp.series(clean,  lint, Copy, concatApp, minifyApp, smoosh, compress);
var packageSeries = gulp.series(clean,  lint, Copy, concatApp, includehtml, includehtml,   minifyApp, smoosh,  clean2, CopyFinal);
var package2Series = gulp.series(clean,  lint, Copy, concatApp, includehtml, includehtml, smoosh);
var package2testSeries = gulp.series(clean,  lint, Copytest, concatApptest, includehtml, includehtml,  smoosh);
